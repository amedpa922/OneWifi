...
//#define WIFI_MULTIAP_ENABLE                 "Device.WiFi.multiap_enable"
...
#define WIFI_ACCESSPOINT_FORCE_APPLY        "Device.WiFi.multiap_enable"
...
typedef enum {
    ...
    wifi_app_inst_multiap = wifi_app_inst_base << 20,
